...
export default function SignUpPage() {
    ...
    const handleEmailSignUp = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push('/onboarding'); // Redirect to onboard flow
        } catch (error: any) {
            ...
            >
                <div className="glass rounded-3xl p-8 border border-white/5 shadow-2xl relative overflow-hidden mt-6">
                    ...
                    <Button
                        type="button"
                        variant="outline"
                        className="w-full h-11 bg-white hover:bg-slate-100 text-slate-900 border-0 flex items-center justify-center gap-2 font-medium"
