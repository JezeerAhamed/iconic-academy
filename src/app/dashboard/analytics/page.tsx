...
import { UpgradeModal, hasAccess } from '@/lib/subscriptions';
...
export default function AnalyticsPage() {
    ...
    const isLocked = !hasAccess(userTier, 'basic');

    return (
        <div className="relative min-h-[60vh]">
            {isLocked && (
                <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-[#080c14]/80 backdrop-blur-md rounded-2xl">
                    <UpgradeModal required="basic" />
                </div>
            )}

            <div className={`space-y-8 pb-12 max-w-6xl mx-auto ${isLocked ? 'opacity-20 pointer-events-none' : ''}`}>
                <div>
